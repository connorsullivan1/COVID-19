...
class CountryViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if country == nil {
            country = Country(Country: "", CountryCode: "", Slug: "", NewConfirmed: 0, TotalConfirmed: 0, NewDeaths: 0, NewRecovered: 0, TotalDeaths: 0, TotalRecovered: 0, Date: "")
        }
        organize()
        updateUserInterface()
    }
    ...
    func updateUserInterface() {
        ...
        dateLabel.text = "\(country.Date)"
        totalCasesLabel.text = "\(country.TotalConfirmed)"
        newCasesLabel.text = "\(country.NewConfirmed)"
    ...
    func updateMap() {
        ...
        var coordinates: CLLocationCoordinate2D {
            let latDouble = latLon[country.CountryCode]?.lat ?? 0
            let latitude = CLLocationDegrees(exactly: latDouble)
            let lonDouble = latLon[country.CountryCode]?.lon ?? 0
            let longitude = CLLocationDegrees(exactly: lonDouble)
    ...
    func organize() {
        ...
        for i in 0..<countryCodes.count {
            latLon[countryCodes[i]] = LatLon(lat: lat[i], lon: lon[i])
        }
    }
